...
function LoginForm({ setLoggedInUser }) {
  ...
  const [isFormWhiteBackground, setIsFormWhiteBackground] = useState(false);
  ...
  const handleUserModalClose = () => {
    ...
    setIsFormWhiteBackground(false); 
  };
      ...
      <Modal open={userModalOpen} onClose={handleUserModalClose}>
        <Box
          sx={{
            width: '100%',
            height: '100%',
            ...(isFormWhiteBackground && { backgroundColor: 'white', padding: '20px' }),
          }}
        >
          <h2>Register User</h2>
